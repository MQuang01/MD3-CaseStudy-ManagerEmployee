...
<%--                    <option value="<c:out value="${listMember.id}"/>">  <c:out value="${listMember.name}"/></option>--%>
                    ...
                    <td class="px-4 py-3 text-sm">
                        <c:forEach var="listTeam" items="${listTeam}">
                            <c:forEach var="projectIdName" items="${projectIdName}">
                                <c:if test="${listMember.teamId == listTeam.id and listTeam.projectId == projectIdName.id}">
                                    ${projectIdName.name}
                                </c:if>
                            </c:forEach>
                        </c:forEach>
